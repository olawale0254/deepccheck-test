...
interactions = [
    ...
    {"input": "When was Deepchecks founded?", "output": "Deepchecks was founded in 2024"},
    {"input": "How are you doing?", "output": "I’m doing just fine, how about you?"},
    {"input": "What is the weather today?", "output": "Today should be warm with a late breeze"},
    ...
    {"input": "Explain quantum computing in simple terms.", "output": "Quantum computing is a type of computation that harnesses the collective properties of quantum states."},
    {"input": "How does a neural network work?", "output": "A neural network works by simulating the behavior of a human brain's neurons."},
    {"input": "What is the capital of France?", "output": "The capital of France is Paris."},
    {"input": "C" * 200, "output": "D" * 10},  # threshold alert for input
    {"input": "E" * 10, "output": "F" * 250},  # outlier alert for output
    {"input": "What is the square root of 16?", "output": "The square root of 16 is 4."},
    {"input": "How do you make a sandwich?", "output": "To make a sandwich, you need bread and fillings such as meat, cheese, or vegetables."},
